...
using Ew.Runtime.Serialization.Binary.Formatters.Generic;
using Ew.Runtime.Serialization.Binary.Interface;
using Ew.Runtime.Serialization.Binary.Resolvers;

namespace Ew.Runtime.Serialization.Binary.Factory.Generic
{
    public static class EnumerableFormatterFactory
    {
        public static IDynamicBinaryFormatable Build<T>()
        {
            ...
            var type = typeof(EnumerableFormatter<>).MakeGenericType(elementType);
